		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GS Innovation",
									"targetURL": "#GSInnovation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GSInnovation-display": {
								"semanticObject": "GSInnovation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gs.fin.bangalore",
									"url": sap.ui.require.toUrl("gs/fin/bangalore")
								}
							}
						}
					}
